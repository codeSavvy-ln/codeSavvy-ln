...
**PROJECTS**
   - **SNOWFLAKE** - [[link]](https://github.com/codeSavvy-ln/Snowflake/tree/main)
      - [Swiggy Data Pipeline](https://github.com/codeSavvy-ln/Snowflake/tree/main/Swiggy%20Data%20Pipeline) - Data is extracted from Postgre DB (which is based on ER model) in the form of CSV then uploaded, transformed and implemented in Dimensional modelling schema and further visualized in streamlit on the snowflake
